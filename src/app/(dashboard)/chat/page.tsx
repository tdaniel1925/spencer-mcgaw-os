...
export default function ChatPage() {
  ...
  // Separate team chat from private DMs
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col bg-background">
            {currentRoom ? (
              <>
                {/* Chat Header */}
                <div className="h-14 border-b px-4 flex items-center gap-3 bg-card/50">
                  {currentRoom.type === "community" ? (
                    <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                      <Users className="h-5 w-5 text-primary" />
                    </div>
                  ) : currentRoom.other_user ? (
                    <div className="relative">
                      <Avatar className="h-10 w-10">
                      ...
                      <PresenceIndicator status={getUserPresence(currentRoom.other_user.id)?.status} size="md" />
                    </div>
                  ) : (
                  ...
                  <div>
                    ...
                    {currentRoom.type === "community" && (
                      <p className="text-xs text-muted-foreground">Everyone in the team</p>
                    )}
                    {currentRoom.type === "private" && currentRoom.other_user && (
                      <p className="text-xs text-muted-foreground">
                        {getUserPresence(currentRoom.other_user.id)?.status === "online"
                          ? "Online"
                          : "Offline"}
                      </p>
                    )}
                              ...
                              >
                                ...
                                <div className={cn("max-w-[70%] relative", isOwn && "text-right")}>
                                  ...
                                  <div className="relative inline-block">
                                    ...
                                    <div className={cn(
                                      "absolute top-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-0.5 bg-background border rounded-md shadow-sm p-0.5 z-10",
                ...
                <div className="p-4 border-t">
                  ...
                  {showMentions && filteredUsers.length > 0 && (
                    <div className="absolute bottom-full left-0 right-0 mb-2 mx-4 bg-background border rounded-lg shadow-lg max-h-48 overflow-y-auto z-20">
